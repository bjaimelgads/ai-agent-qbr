...
The legacy WebSocket contract is documented at `docs/architecture/websocket-protocol.md`.
Key message types:
...
Docs: `docs/observability/mlflow_tracing.md`
...
- MLflow tracing: `docs/observability/mlflow_tracing.md`
