...
_DEF = [
        ...
        MetricCatalogEntry(
            metric_id="installs",
            name="Installs",
            aliases=_aliases("install", "installs", "total installs"),
            expected_unit="count",
            description=None,
            formula=None,
            priority=2,
        ...
        MetricCatalogEntry(
            metric_id="launches",
            name="Launches",
            aliases=_aliases("launches", "launch", "total launches"),
            expected_unit="count",
            description=None,
            formula=None,
            priority=2,
    ...
    MetricCatalogEntry(
        metric_id="investment",
        name="Investment",
        aliases=_aliases("investment", "total investment"),
        expected_unit="currency",
        priority=2,
    ),
    MetricCatalogEntry(
        metric_id="spend",
        name="Spend",
        aliases=_aliases("spend", "spending", "total spend"),
        expected_unit="currency",
        priority=2,
    ),
    MetricCatalogEntry(
