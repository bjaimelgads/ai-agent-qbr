...
# Sync
cp "$ROOT_DIR/deploy/prd/prd-qbr.app.yaml" app.yaml
...
databricks sync . /Workspace/Users/damian.beltritti@consultants.lgads.tv/databricks_apps/prd-qbr-agent

# Back to root
cd "$ROOT_DIR"

# Deploy prd version
databricks apps deploy prd-qbr-agent --source-code-path /Workspace/Users/damian.beltritti@consultants.lgads.tv/databricks_apps/prd-qbr-agent
