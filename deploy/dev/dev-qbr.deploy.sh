...
# Sync
cp ./../deploy/dev/dev-qbr.app.yaml app.yaml

databricks sync . /Workspace/Users/damian.beltritti@consultants.lgads.tv/databricks_apps/dev-qbr-agent-d1

# Back to root
cd ..

# Deploy dev version
databricks apps deploy dev-qbr-agent --source-code-path /Workspace/Users/damian.beltritti@consultants.lgads.tv/databricks_apps/dev-qbr-agent-d1
